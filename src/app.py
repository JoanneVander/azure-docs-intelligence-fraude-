...
def configure_interface():
    st.title("Upload de Arquiso DIO - Desafio 1 - Azure - Fake Docs")
    ...
    if uploaded_file is not None:
      ...
      if blob_url:
        ...
        credit_card_info = analyze_credit_card(blob_url) # Chamar a função de detecção de cartao de crédito
...
def show_image_and_validation(blob_url, credit_card_info):
   ...
   if credit_card_info and credit_card_info["card_name"]:
      ...
      st.write("Esse não é um númeron de cartão válido")
